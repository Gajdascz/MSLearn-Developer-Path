...
public static class JsonRetrievalAsyncParallel
{
  ...
  public static async Task<BankCustomerDTO> LoadBankCustomerDTOAsync(string filePath)
  {
    ...
    var customerDTO =
      JsonSerializer.Deserialize<BankCustomerDTO>(json, _options)
      ?? throw new Exception("Customer could not be deserialized.");
    return customerDTO;
  }

  public static async Task<BankCustomer> LoadBankCustomerAsyncParallel(
    Bank bank,
    string filePath,
  ...
  public static async Task<IEnumerable<BankCustomer>> LoadAllCustomersAsyncParallel(
    Bank bank,
  ...
  )
  {
    ...
    await Parallel.ForEachAsync(
      ...
      async (filePath, _) =>
      {
        var customer = await LoadBankCustomerAsyncParallel(
          bank,
          filePath,
  ...
  public static async Task<BankAccount> LoadBankAccountAsync(
  ...
  public static async Task<IEnumerable<Transaction>> LoadAllTransactionsAsync(string filePath)
  {
    ...
    var transactions =
      JsonSerializer.Deserialize<IEnumerable<Transaction>>(jsonTransaction, _options)
  ...
  public static async Task<BankAccountDTO> LoadBankAccountDTOAsync(string filePath)
  {
    ...
    var accountDTO =
      JsonSerializer.Deserialize<BankAccountDTO>(json, _options)
