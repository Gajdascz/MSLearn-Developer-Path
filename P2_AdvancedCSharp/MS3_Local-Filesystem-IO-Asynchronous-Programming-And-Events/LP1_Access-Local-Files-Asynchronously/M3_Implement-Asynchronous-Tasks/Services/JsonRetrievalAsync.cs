...
public static class JsonRetrievalAsync
{
  ...
  public static async Task<BankCustomer> LoadBankCustomerAsync(
    Bank bank,
    string filePath,
  ...
  public static async Task<IEnumerable<BankCustomer>> LoadAllCustomersAsync(
    Bank bank,
  ...
  )
  {
    ...
    {
      BankAccount recoveredBankAccount = new(customer, customer.CustomerId, accountDTO.Balance, accountDTO.AccountType);
  ...
  public static async Task<BankAccountDTO> LoadBankAccountDTOAsync(string filePath)
  {
    ...
    return await JsonSerializer.DeserializeAsync<BankAccountDTO>(stream, _options) is BankAccountDTO accountDTO
      ? accountDTO
