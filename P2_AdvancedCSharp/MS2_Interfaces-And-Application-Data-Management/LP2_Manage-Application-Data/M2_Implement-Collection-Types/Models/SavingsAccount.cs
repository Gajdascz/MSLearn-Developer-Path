...
public class SavingsAccount : BankAccount
{
  ...
  public SavingsAccount(IBankCustomer customer, double balance = 500, int withdrawalLimit = 6)
    : base(customer, balance, "Savings")
  {
  ...
  public override string DisplayAccountInfo()
  {
    return base.DisplayAccountInfo()
      + $", Withdrawal Limit: {WithdrawalLimit}, Withdrawals This Month: {_withdrawalsThisMonth}";
  }
}
