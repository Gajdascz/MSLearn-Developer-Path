...
public class MoneyMarketAccount : BankAccount
{
  ...
  public MoneyMarketAccount(IBankCustomer customer, double balance = 2000, double minimumBalance = 1000)
    : base(customer, balance, "Money Market")
  {
  ...
  public override string DisplayAccountInfo()
  {
    return base.DisplayAccountInfo()
      + $", Minimum Balance: {MinimumBalance}, Minimum Opening Balance: {MinimumOpeningBalance}";
  }
}
