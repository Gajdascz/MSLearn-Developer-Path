...
public class CheckingAccount : BankAccount
{
  ...
  public CheckingAccount(IBankCustomer customer, double balance = 200, double overdraftLimit = 500)
    : base(customer, balance, "Checking")
  {
  ...
  public override bool Withdraw(double amount)
  {
    if (amount > 0 && Balance + OverdraftLimit >= amount)
    {
      ...
      if (Balance < 0)
      {
        double overdraftFee = AccountCalculations.CalculateOverdraftFee(
          Math.Abs(Balance),
