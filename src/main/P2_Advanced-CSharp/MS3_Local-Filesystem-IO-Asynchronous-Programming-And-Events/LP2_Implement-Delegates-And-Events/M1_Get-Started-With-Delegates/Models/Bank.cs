...
public class Bank
{
  ...
  internal IEnumerable<BankCustomer> GetCustomersByName(string firstName, string lastName)
  {
    ...
    {
      if (
        customer.FirstName.Equals(firstName, StringComparison.OrdinalIgnoreCase)
  ...
  internal BankCustomer? GetCustomerById(string customerId)
  {
    return _customers.FirstOrDefault(customer =>
      customer.CustomerId.Equals(customerId, StringComparison.OrdinalIgnoreCase)
    );
  }
  ...
  public IEnumerable<BankCustomer> GetSortedCustomers(Comparison<BankCustomer> comparison)
  {
